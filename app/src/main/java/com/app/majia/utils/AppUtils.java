...
public class AppUtils {
    ...
    public static void installApp(File file, String authority) {
        ...
        AppContext.appContext.startActivity(IntentUtils.getInstallAppIntent(file, authority));
    }
    ...
    public static void uninstallApp(String packageName) {
        ...
        AppContext.appContext.startActivity(IntentUtils.getUninstallAppIntent(packageName));
    }
    ...
    public static boolean isAppRoot() {
        ...
        if (result.errorMsg != null) {
            LogUtil.v("isAppRoot" + result.errorMsg);
        }
        return false;
    }
    ...
    public static void launchApp(String packageName) {
        if (isSpace(packageName)) return;
        AppContext.appContext.startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
    ...
    public static String getAppPackageName() {
        return AppContext.appContext.getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(AppContext.appContext.getPackageName());
    }
    ...
    public static void getAppDetailsSettings(String packageName) {
        if (isSpace(packageName)) return;
        AppContext.appContext.startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName() {
        return getAppName(AppContext.appContext.getPackageName());
    }
    ...
    public static String getAppName(String packageName) {
        ...
        try {
            PackageManager pm = AppContext.appContext.getPackageManager();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(AppContext.appContext.getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(AppContext.appContext.getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(AppContext.appContext.getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(AppContext.appContext.getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(AppContext.appContext.getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(AppContext.appContext.getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(AppContext.appContext.getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager = (ActivityManager) AppContext.appContext.getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = manager.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(AppContext.appContext.getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(AppContext.appContext.getPackageName());
    }
    ...
    public static String getUmengChannel(Context ctx) {
        if (UMENG_CHANNEL==null){
            UMENG_CHANNEL=  getAppMetaData(ctx,"UMENG_CHANNEL");
        }
